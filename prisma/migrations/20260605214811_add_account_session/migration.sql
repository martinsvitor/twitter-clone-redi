...
*/
-- DropForeignKey
ALTER TABLE "Dislike" DROP CONSTRAINT "Dislike_tweetId_fkey";
...
ALTER COLUMN "userId" SET DATA TYPE TEXT,
ALTER COLUMN "tweetId" SET DATA TYPE TEXT,
ADD CONSTRAINT "Retweet_pkey" PRIMARY KEY ("userId", "tweetId");
...
CREATE TABLE "Account" (
    ...
    CONSTRAINT "Account_pkey" PRIMARY KEY ("userId","provider","providerAccountId")
);
